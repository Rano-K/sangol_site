    ...
    <div className="flex-1 bg-[#FAFAF7] flex flex-col min-h-screen">
      ...
      <div className="relative h-64 md:h-80 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-6">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4">농장 소개</h1>
          <p className="text-[#E8DFCA] text-lg">자연 그대로의 방식을 고집하는 산골의 청정 농장</p>
        </div>
      </div>
      <SectionQuickLinks items={BUSINESS_QUICK_LINKS} />

      <div className="max-w-7xl mx-auto px-6 py-20 md:py-32 w-full flex flex-col items-center gap-12 md:gap-16">
        
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1A4D2E] mb-6 leading-tight">
            자연과 사람이 피워낸<br className="md:hidden" /> 건강한 먹거리
          </h2>
          <p className="text-gray-600 text-lg leading-relaxed">
            농업 법인(주)산골은 청정 두메산골에서 가장 친환경적인 방식으로 재배하며,<br className="hidden md:block" />
            정직과 신뢰를 바탕으로 자연의 가치를 지키고 건강과 행복을 더합니다.
          </p>
        </div>

        {/* Provided Banner Image */}
        <div className="w-full max-w-6xl mx-auto rounded-[2rem] overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 border border-[#E8DFCA]/60">
          <ImageWithFallback
            src={farmImage}
