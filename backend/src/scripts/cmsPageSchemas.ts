/** Empty CMS section shapes — must stay in sync with admin/src/app/lib/cmsPageSchemas.ts */
export const PAGE_SECTION_SCHEMAS: Record<string, Record<string, unknown>> = {
  'site-layout': {
    topMenu: { loginLabel: '', loginLink: '', mypageLabel: '', mypageLink: '', noticeText: '' },
    logo: { headerLogoMediaId: '', footerLogoMediaId: '' },
    typography: { enabled: true, fontMediaId: '', fontMediaIdEn: '', fontFamilyName: '', fontFamilyNameEn: '' },
    footer: { ownerName: '', address: '', csPhone: '', fax: '', email: '', copyright: '' },
  },
  home: {
  ...
  order: { payment: { accountName: '', accountNumber: '', requiredNotice: '' } },
  'company-greeting': {
    headerTitle: '',
    headerSubtitle: '',
    messageTitle: '',
