...
export function Login() {
  ...
  if (isAuthenticated && user) {
    return (
      <div className="flex-1 bg-[#F4F6F1] py-20">
        <div className="site-container site-container--narrow">
          <div className="mx-auto max-w-xl bg-white border border-[#E2E8D9] rounded-2xl p-8 text-center">
  ...
  return (
    <div className="flex-1 bg-[#F4F6F1] py-20">
      <div className="site-container site-container--narrow">
        <div className="mx-auto max-w-xl bg-white border border-[#E2E8D9] rounded-2xl p-8">
